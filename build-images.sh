...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=docker.io/postgres:15.10-alpine docker.io/bitnami/elasticsearch:8.17.2 docker.io/zammad/zammad-docker-compose:6.4.1-33 docker.io/memcached:1.6.34-alpine docker.io/redis:7.4.2-alpine" \
    "${container}"
# Commit the image
