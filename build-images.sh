...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=docker.io/postgres:15.13-alpine docker.io/bitnami/elasticsearch:8.18.0 ghcr.io/zammad/zammad:6.5.0-85 docker.io/memcached:1.6.38-alpine docker.io/redis:7.4.4-alpine" \
    "${container}"
# Commit the image
