...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=docker.io/postgres:17.9-alpine docker.io/elasticsearch:9.3.2 ghcr.io/zammad/zammad:7.0.0-0042 docker.io/memcached:1.6.41-alpine docker.io/redis:8.6.1-alpine" \
    "${container}"
# Commit the image
